...
var PdfViewerComponent = (function () {
    var PdfViewerComponent = PdfViewerComponent_1 = function PdfViewerComponent(element) {
    ...
    PdfViewerComponent.prototype.updateSize = function () {
        ...
        if (!this._originalSize) {
            ...
            this._pdf.getPage(this._pdfViewer.currentPageNumber).then(function (page) {
                var scale = _this._zoom * (offsetWidth_1 / page.getViewport(1).width) / PdfViewerComponent_1.CSS_UNITS;
    ...
    PdfViewerComponent.prototype.renderPage = function (pageNumber) {
        ...
        this._pdf.getPage(pageNumber).then(function (page) {
            ...
            var scale = _this._zoom * (offsetWidth / page.getViewport(1).width) / PdfViewerComponent_1.CSS_UNITS;
