...
var Rule = (function (_super) {
    ...
    Rule.FAILURE_STRING_PREFIX = "The key '";
    Rule.FAILURE_STRING_POSTFIX = "' is not sorted alphabetically";
    return Rule;
        ...
        if (sortedState) {
            ...
            if (keyNode.kind === ts.SyntaxKind.Identifier) {
                ...
                if (key < lastSortedKey) {
                    var failureString = Rule.FAILURE_STRING_PREFIX + key + Rule.FAILURE_STRING_POSTFIX;
